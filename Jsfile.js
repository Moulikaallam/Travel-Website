...
var swiper = new Swiper(".swiper.mySwiper", {
    loop: true,  // Enable infinite loop
    autoplay: {
        delay: 3000,  // 3 seconds delay per slide
        disableOnInteraction: false,  // Keep autoplay running even if user interacts with the swiper
    },
    slidesPerView: 1,  // Display one slide at a time (you can change to 2, 3, etc. for multiple slides visible)
    spaceBetween: 20,  // Space between slides (you can adjust this value as needed)
    navigation: {
